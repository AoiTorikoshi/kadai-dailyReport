...
/**
 * Servlet implementation class ProjectsIndexServlet
 */
@WebServlet("/projects/index")
public class ProjectsIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProjectsIndexServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/projects/index.jsp");
